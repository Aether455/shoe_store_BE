...
public enum ErrorCode {
    ...
    INVALID_PHONE_NUMBER(2014, "Số điện thoại không hợp lệ (phải bắt đầu bằng 0 hoặc +84 và có 10 chữ số)", HttpStatus.BAD_REQUEST),
    ...
    CANNOT_DELETE_STAFF_LINKED_USER(2105, "Không thể xóa nhân viên này do đang liên kết với tài khoản User hoặc dữ liệu khác.", HttpStatus.CONFLICT),
    ...
    CANNOT_DELETE_CATEGORY(3104, "Không thể xóa danh mục này do có danh mục con hoặc sản phẩm liên quan!", HttpStatus.CONFLICT),
    ...
    ORDER_CONFIRM_STATUS_INVALID(4105, "Chỉ có thể xác nhận đơn hàng khi trạng thái là PENDING (Chờ xử lý)!", HttpStatus.BAD_REQUEST),
    ORDER_CHANGE_INFO_STATUS_INVALID(4106, "Chỉ có thể thay đổi thông tin khi đơn hàng đang PENDING (Chờ xử lý)!", HttpStatus.BAD_REQUEST),
    ORDER_CANCEL_STATUS_INVALID(4107, "Chỉ có thể hủy đơn hàng khi trạng thái là PENDING (Chờ xử lý)!", HttpStatus.BAD_REQUEST),
    ...
    CANNOT_DELETE_VOUCHER_LINKED_ORDER(5008, "Không thể xóa voucher do đã được sử dụng trong đơn hàng!", HttpStatus.CONFLICT),
    ...
    CANNOT_DELETE_SUPPLIER_LINKED_PURCHASE_ORDER(6103, "Không thể xóa nhà cung cấp do đang liên kết với phiếu nhập hoặc dữ liệu hoạt động!", HttpStatus.CONFLICT),

    // Purchase Order (Nhập hàng)
    PURCHASE_ORDER_NOT_EXISTED(6200, "Phiếu nhập hàng không tồn tại!", HttpStatus.NOT_FOUND),
    STATUS_IS_NOT_CHANGE_TO_APPROVED(6201, "Không thể thay đổi trạng thái khi phiếu nhập đã DUYỆT hoặc HỦY!", HttpStatus.BAD_REQUEST),
    STATUS_IS_NOT_CHANGE_TO_CANCEL(6202, "Không thể thay đổi trạng thái khi phiếu nhập đã HỦY!", HttpStatus.BAD_REQUEST),
    DELETE_FAIL_BY_STATUS(6203, "Không thể xóa phiếu nhập khi trạng thái là ĐÃ DUYỆT hoặc ĐÃ HỦY!", HttpStatus.BAD_REQUEST),
    ...
    CONCURRENT_MODIFICATION(6302, "Dữ liệu kho đã bị thay đổi bởi giao dịch khác. Vui lòng thử lại!", HttpStatus.CONFLICT),
    ;
