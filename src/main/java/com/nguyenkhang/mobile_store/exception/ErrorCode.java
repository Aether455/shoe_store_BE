...
public enum ErrorCode {
    ...
    ORDER_CHANGE_INFO_STATUS_INVALID(6885, "Order information can only be change when status is PENDING!", HttpStatus.BAD_REQUEST),
...
//
    ...
    STATUS_IS_NOT_CHANGE_TO_APPROVED(4653, "Purchase order status NOT change when status is APPROVED or CANCELLED!", HttpStatus.BAD_REQUEST),
    STATUS_IS_NOT_CHANGE_TO_CANCEL(4653, "Purchase order status NOT change when status is CANCELLED!", HttpStatus.BAD_REQUEST),
    ...
    CONCURRENT_MODIFICATION(3645, "Inventory record was updated by another transaction. Please retry your operation.", HttpStatus.CONFLICT),
